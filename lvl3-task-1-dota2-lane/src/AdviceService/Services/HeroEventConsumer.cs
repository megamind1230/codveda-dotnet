...
public class HeroEventConsumer : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        try
        {
            ...
            var queueName = "advice-service.hero-events";
            ...
            _logger.LogInformation("AdviceService subscribed to dotalane.hero -> {Queue}", queueName);
            ...
            {
                _logger.LogInformation("AdviceService RabbitMQ consumer stopping");
            }
        }
        catch (Exception ex)
        {
